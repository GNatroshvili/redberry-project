...
export default function Home() {
  return (
    <>
      ...
      <Difficulty size="big" color="red" text="High Priority" />
      <Difficulty size="big" color="green" text="Low Priority" />
      <Difficulty size="small" color="orange" text="Medium Priority" />
    </>
  );
}
